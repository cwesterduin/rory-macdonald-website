...
<b className={aboutStyles.header}>Academic work</b>
  ...
  <p className={aboutStyles.timeline_header}>2018</p>
    ...
    <li>Deconstructing Modernism: Rethinking the Art Historical Approoach to Transnational Modern Artists from Beyond the West, with the Gutai Group as a Case Study.</li>
    </ul>
...
<p className={aboutStyles.timeline_header}>2019</p>
    ...
    <li>Walking through the Index: An Examination of Role of Text in Hamish Fulton's Walking Art.
    Sculpting Nigerian Identity: An Examination of Representation of Clothing Within State-Commissioned Sculpture in Lagos and an Assessment of its Role in Building a Nigerian National Identity.</li>
    </ul>
